...
import 'm3interac_copy_model.dart';
export 'm3interac_copy_model.dart';

class M3interacCopyWidget extends StatefulWidget {
  const M3interacCopyWidget({super.key});

  @override
  State<M3interacCopyWidget> createState() => _M3interacCopyWidgetState();
}

class _M3interacCopyWidgetState extends State<M3interacCopyWidget> {
  late M3interacCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => M3interacCopyModel());
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/baby-pinguin-dauntless-with-human-gestures-more-ex-removebg-preview.png',
                          width: 313.0,
                          height: 381.0,
                          fit: BoxFit.cover,
                        ),
