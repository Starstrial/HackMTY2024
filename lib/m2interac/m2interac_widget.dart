...
import 'm2interac_model.dart';
export 'm2interac_model.dart';

class M2interacWidget extends StatefulWidget {
  const M2interacWidget({super.key});

  @override
  State<M2interacWidget> createState() => _M2interacWidgetState();
}

class _M2interacWidgetState extends State<M2interacWidget> {
  late M2interacModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => M2interacModel());
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/pink-axolotle-big-eyes-removebg-preview.png',
                          width: 313.0,
                          height: 381.0,
                          fit: BoxFit.cover,
                        ),
