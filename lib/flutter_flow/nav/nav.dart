...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AvisoDeCrearCuenta',
          path: '/avisoDeCrearCuenta',
          builder: (context, params) => const AvisoDeCrearCuentaWidget(),
        ),
        FFRoute(
          name: 'P1',
          path: '/p1',
          builder: (context, params) => const P1Widget(),
        ),
        FFRoute(
          name: 'MAIN',
          path: '/main',
        ...
        FFRoute(
          name: 'P2',
          path: '/p2',
          builder: (context, params) => const P2Widget(),
        ),
        FFRoute(
          name: 'P3',
          path: '/p3',
          builder: (context, params) => const P3Widget(),
        ),
        FFRoute(
          name: 'P4',
          path: '/p4',
          builder: (context, params) => const P4Widget(),
        ),
        FFRoute(
          name: 'P5',
          path: '/p5',
          builder: (context, params) => const P5Widget(),
        ),
        FFRoute(
          name: 'P6',
          path: '/p6',
          builder: (context, params) => const P6Widget(),
        ),
        FFRoute(
          name: 'P7',
          path: '/p7',
          builder: (context, params) => const P7Widget(),
        ),
        FFRoute(
          name: 'ID',
          path: '/id',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Banorte_Splash_Screen.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
